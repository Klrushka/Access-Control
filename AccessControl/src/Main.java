...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        //! System.out.println(task5.protectedString);                  // 'protectedString' has protected access in 'Task5Pac.Task5'
        //! System.out.println(task5.inPacAccess);                      // 'inPacAccess' is not public in 'Task5Pac.Task5'. Cannot be accessed from outside package
